...
## General info
The web app for sentiment analysis of clothes reviews. In this project I developed a REST API using the Flask framework and ML pretrained model. It is a simple method on implementing machine learning APIs.
